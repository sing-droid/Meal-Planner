  ...
  fetch(url)
    ...
    .then((responseData) => {
      ...
      responseData.meals.forEach((data, index) => {
        let url3 = `https://api.spoonacular.com/recipes/${data.id}/information?apiKey=${authId}`;
        fetch(url3)
          .then((res) => res.json())
          .then((res) => {
...
submitbtn.addEventListener("click", (event) => {
  ...
  weight.style.borderColor = "rgb(203, 203, 203)";
  height.style.borderColor = "rgb(203, 203, 203)";
  age.style.borderColor = "rgb(203, 203, 203)";
  if(height.value == "" ) {
